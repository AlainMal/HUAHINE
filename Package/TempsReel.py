...
# Cette classe sert uniquement à traiter les résultats.
...
class TempsReel:
    ...
    # Méthode d'enregistremnt du bus CAN en temps réel. ----------------------------------------------------------------
    @staticmethod
    async def TempsReel(msg:CanMsg, file_path, coche_file, coche_buffer,coche_nmea, main_window):
